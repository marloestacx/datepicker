...
Op de eindpagina als je je reis gepland heb krijg je een random gifje van een trein te zien, dit voegt qua functionaliteit niks toe maar is toch altijd een leuke verrassing aan het einde. Vanaf de homepagina kan je kiezen om een lijst van aanbevolen boeken te zien, dit is een lijst van de top 15 boeken van de New York Times bestsellerlijst. Als je op een van de boeken klikt ga je automatisch naar de Amazon pagina zodat je het boek meteen kan kopen. 
...
- Je hebt maar 1 input veld nodig bij werk 
- Bij een dagje weg zou je de laatste keuzen als vertrek plek kunnen zien

#### Aanpak

Ik ga de laatste bevindingen toepassen in mijn prototype. Zo ga ik bij het werk het aankomststation weghalen en bij het dagje weg toevoegen dat hij je laatste eindstation nu automatisch als vertrek station instelt. 
